...
import { IsOptional, IsString, IsEnum, IsArray, IsNumber, ValidateNested, IsInt } from 'class-validator';
import { ApiProperty } from '@nestjs/swagger';
import { ContactStatus, NumberStatus } from '@prisma/client';
...
export class UpdateContactDto {
  ...
  @ApiProperty({ example: NumberStatus.VERIFIED, enum: NumberStatus, required: false })
  @IsOptional()
  @IsEnum(NumberStatus)
  ...
  @ApiProperty({ type: () => [ContactCustomFieldDto], required: false, description: 'Custom fields for the contact' })

  @Type(() => ContactCustomFieldDto)
  @IsOptional()
  contactCustomField: ContactCustomFieldDto[];
